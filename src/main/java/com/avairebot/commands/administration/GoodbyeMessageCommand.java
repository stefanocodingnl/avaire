...
public class GoodbyeMessageCommand extends ChannelModuleCommand {
    ...
    public String getDescription() {
        return "Sets the message that should be sent when a user leaves the server, this command can only be used if the goodbye module is enabled for the current channel.\nThe goodbye message has support for [placeholders](https://gitlab.com/pinewood-builders/discord/xeus/wiki/placeholders), allowing for customizing the message a bit more for each user.\nhttps://gitlab.com/pinewood-builders/discord/xeus/wiki/placeholders";
    }
