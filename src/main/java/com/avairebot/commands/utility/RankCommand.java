...
public class RankCommand extends Command {
    ...
    private void sendEmbeddedMessage(
        ...
        MessageFactory.makeEmbeddedMessage(context.getChannel(), Color.decode("#E91E63"))
            .setAuthor(author.getName(), "https://xeus.pinewood-builders.com/leaderboard/" + context.getGuild().getId(), author.getEffectiveAvatarUrl())
            .setFooter("https://xeus.pinewood-builders.com/leaderboard/" + context.getGuild().getId())
