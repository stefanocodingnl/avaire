...
public class Main {
    ...
    public static void main(String[] args) throws IOException, SQLException, InvalidApplicationEnvironmentException {
        ...
        options.addOption(new Option("gsf", "generate-json-file", false, "Enters command generation mode, when this flag is enabled, the bot won't actually start, but will instead generate a \"commandMap.json\" file containing information about all the registered commands. This file is used for xeus.pinewood-builders.com to generate the commands page."));
