...
import com.avairebot.commands.onwatch.OnWatchCommand;
...
public class OnWatchlog {
     ...
     */
    @Nullable
    public static String log(AvaIre avaire, CommandMessage context, OnWatchAction action) {
     ...
     */
    @Nullable
    public static String log(AvaIre avaire, Message message, OnWatchAction action) {
     ...
     */
    @Nullable
    public static String log(AvaIre avaire, Guild guild, OnWatchAction action) {
     ...
     */
    @Nullable
    public static String log(AvaIre avaire, Guild guild, GuildTransformer transformer, OnWatchAction action) {
        ...
        avaire.getEventEmitter().push(new OnWatchActionEvent(
     ...
     */
    public static void notifyUser(User user, Guild guild, OnWatchAction action, @Nullable String caseId) {
    ...
    private static void logActionToTheDatabase(AvaIre avaire, Guild guild, OnWatchAction action, Message message, int modlogCase) {
        try {
