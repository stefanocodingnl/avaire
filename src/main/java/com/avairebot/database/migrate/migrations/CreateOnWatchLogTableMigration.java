...
public class CreateOnWatchLogTableMigration implements Migration {
    ...
    public boolean up(Schema schema) throws SQLException {
        return schema.createIfNotExists(Constants.ON_WATCH_LOG_TABLE_NAME, table -> {
    ...
    public boolean down(Schema schema) throws SQLException {
        return schema.dropIfExists(Constants.ON_WATCH_LOG_TABLE_NAME);
    }
}
